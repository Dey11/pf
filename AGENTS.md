...
- Homepage section labels are a sequential binary index, not decimal item counts. The active order is About `(000)`, tech stack `(001)`, experience `(010)`, projects `(011)`, Screening Room `(100)`, Field Notes `(101)`, and Connect `(110)`; renumber the sequence when mounted sections change.
