...
import ChannelVariant from "./channel-variant";
import IndexVariant from "./index-variant";
import TicketsVariant from "./tickets-variant";

const variants = [
  { name: "Index", Component: IndexVariant },
  { name: "Channel", Component: ChannelVariant },
  { name: "Tickets", Component: TicketsVariant },
];
    ...
    <>
      ...
      <div className="min-h-screen pt-16 sm:pt-6">
        <div className="flex items-center justify-between border-b border-white/10 pb-3 text-[10px] tracking-[0.18em] text-white/35 uppercase sm:text-xs">
          <span>prototype / screening room</span>
          <span>keys 1–3 or ← →</span>
        </div>
